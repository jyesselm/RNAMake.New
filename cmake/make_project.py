...
depends = {
    ...
    'state': ['primitives'],
    'all_atom' : ['secondary_structure', 'state'],
    'resource_management' : ['all_atom'],
    'segment_data_structures' : ['resource_management']
}

libs = "base math util primitives data_structures secondary_structure state all_atom resource_management segment_data_structures"
