...
PYBIND11_PLUGIN(math_util) {
    ...
    m.def("dot_vector", &dot_vector);


    m.def("are_floats_equal", &are_floats_equal, py::arg("a"), py::arg("b"),
          py::arg("tol") = 0.001);

    m.def("are_points_equal", &are_points_equal, py::arg("p1"), py::arg("p2"),
          py::arg("tol") = 0.001);

    m.def("are_matrices_equal", &are_matrices_equal);
