...
PYBIND11_PLUGIN(secondary_structure) {
    ...
    py::class_<Chain, std::shared_ptr<Chain>>(m, "Chain")
            ...
            .def("set_residue_identity", &Chain::set_residue_identity)
    ...
    py::class_<Structure, std::shared_ptr<Structure>>(m, "Structure")
            ...
            .def("set_residue_identity", &Structure::set_residue_identity)
    ...
    py::class_<Pose, std::shared_ptr<Pose>>(m, "Pose")
            ...
            .def("set_residue_identity", &Pose::set_residue_identity)
